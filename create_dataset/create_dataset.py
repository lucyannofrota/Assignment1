...
def create_dataset(test):
    ...
    if test:
<<<<<<< HEAD
        df.to_csv('docker_l/notebooks/dts/test.csv',index=False)
    else:
        df.to_csv('docker_l/notebooks/dts/train.csv',index=False)
=======
        df.to_csv('../docker_m/notebooks/dts_plain/test.csv',index=False)
    else:
        df.to_csv('../docker_m/notebooks/dts_plain/train.csv',index=False)
>>>>>>> main
